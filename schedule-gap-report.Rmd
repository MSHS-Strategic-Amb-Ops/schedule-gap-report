...
#   mutate(expected_min = (40*Outpatient)*4*60,
#          expected_avail_min_variance = avail_min - expected_min,
...
# 
# gap_analysis_filtered <- gap_analysis %>%
#   filter(!is.na(`Master Dept`))
# 
# write.xlsx(gap_analysis_filtered, "Gap Analysis.xlsx")
